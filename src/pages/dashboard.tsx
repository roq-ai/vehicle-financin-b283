...
function DashboardPage() {
  ...
  const financialAdvisorStat = useFinancialAdvisorCount();

  const vehicleLoanStat = useVehicleLoanCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: financialAdvisorStat?.data,
      isLoading: financialAdvisorStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Vehicle Loans',
      result: vehicleLoanStat?.data,
      isLoading: vehicleLoanStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Loan Officers',
