  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Vehicle Financing Application: Empowering You to Understand and Compare Interest Rates for Two & Four Wheeler Vehicle Loans"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Vehicle Financing Application: Empowering You to Understand and Compare Interest Rates for Two & Four Wheeler Vehicle Loans`}
            </Text>
            <Box
