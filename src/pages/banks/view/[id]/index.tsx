...
import { useBankFindFirst, useRoqClient } from 'lib/roq';

import { BankInterface } from 'interfaces/bank';
import { LoanOfficerListPage } from 'pages/loan-officers';
import { VehicleLoanListPage } from 'pages/vehicle-loans';
...
function BankViewPage() {
  ...
  const { data, error, isLoading } = useBankFindFirst(queryParams, {}, { disabled: !id });
